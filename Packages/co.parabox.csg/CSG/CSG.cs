    ...
    public static class CSG
    {
        ...
        public static Model Perform(BooleanOp op, GameObject lhs, GameObject rhs)
        {
            switch (op)
            {
                ...
                case BooleanOp.MakeSlice:
                    return MakeSlice(lhs, rhs);
                case BooleanOp.MakeHalfOfTheTree:
                    return MakeHalfOfTheTree(lhs, rhs);
                default:
                    return null;
            }
        }
        ...
        public static Model MakeSlice(GameObject lhs, GameObject rhs)
        {
            Model csg_model_a = new Model(lhs);
            Model csg_model_b = new Model(rhs);
            ...
            List<Polygon> polygons = Node.MakeSlice(a, b).AllPolygons();

            return new Model(polygons);
        }

        public static Model MakeHalfOfTheTree(GameObject lhs, GameObject rhs)
        {
            Model csg_model_a = new Model(lhs);
            Model csg_model_b = new Model(rhs);
            ...
            List<Polygon> polygons = Node.MakeHalfOfTheTree(a, b).AllPolygons();
